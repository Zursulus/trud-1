...
test "$code" = 200
trap - ERR
echo 'ГОТОВО: рабочее место оператора воды установлено. Главная HTTP 200, админка HTTP 302.'
echo 'Путь после входа: Учёт воды → Показания счётчиков → Рабочее место оператора.'
