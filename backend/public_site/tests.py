...
class PublicContentTests(TestCase):
    ...
    def test_static_frontend_is_wired_to_public_feed(self):
        ...
        letter = (root / 'feodosia-letter-2026-08-27.html').read_text(encoding='utf-8')
        ...
        self.assertIn('feodosia-letter-2026-08-27.html', index)
        self.assertNotIn('feodosia-letter-2026-08-27.webp', index)
        self.assertIn('№ 2-47-10604', letter)
        self.assertIn('Администрация города Феодосии', letter)
        self.assertIn('текстовая копия', letter)
